...
- [Upstream migration packet `2026-04-threat-model-and-safety-harness/`](https://github.com/mannepanne/useful-assets-template/tree/main/REFERENCE/TEMPLATE-UPDATES/2026-04-threat-model-and-safety-harness/) — lives in the upstream template repo (this project is a packet *consumer* per `REFERENCE/TEMPLATE-UPDATES/CLAUDE.md`); ships these allow-list entries to derivative projects and references this principle when documenting the validation-tooling group.
