...
| `FeaturedDispatch` | Per-day "Dispatch of the Day" — eyebrow, species `<h2>`, italic pull-quote, signature with time-of-day phrase. Mirrored layout via `sm:flex-row-reverse` when `mirrored=true`. First-discovery treatment: amber-tinted frame (`border-amber-700/40` + `ring-amber-500/20`), "⭐ New to science · Dispatch of the day" eyebrow, "First sighting in the world." caption beneath the species name, signature reads "— first documented by **Name**" with bolder weight. |
