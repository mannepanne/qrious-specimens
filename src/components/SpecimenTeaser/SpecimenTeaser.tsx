...
// ABOUT: Circular illustration container — AI thumbnail or Victorian sketch renderer; shows first-discoverer pineapple
...
/** Victorian pineapple — symbol of hospitality, status and exploration */
